...
.orb-1{width:340px;height:340px;background:var(--accent);top:-80px;left:-100px;animation:float1 14s ease-in-out infinite alternate}
.orb-2{width:280px;height:280px;background:var(--gold);bottom:-90px;right:-60px;animation:float2 17s ease-in-out infinite alternate}
.orb-3{width:200px;height:200px;background:#7a1230;top:40%;right:10%;animation:float1 11s ease-in-out infinite alternate-reverse}
...
.row-between{display:flex;align-items:center;justify-content:space-between;margin-bottom:22px;font-size:.82rem}
.checkbox{display:flex;align-items:center;gap:7px;color:var(--muted)}
...
<div class="split">
  ...
  <aside class="brand-panel">
    ...
    <div class="brand-panel-mid">
      <h2>Your next favorite film,<br>one <span>conversation</span> away.</h2>
      <p>A movie recommendation engine that actually explains itself — grounded in real
      data, ranked by what you truly like.</p>

      <div class="feature-list">
        <div class="feature-item">
          <div class="feature-icon"><i class="bi bi-search"></i></div>
          <div class="feature-text">
            <strong>Hybrid AI search</strong>
            Semantic + keyword retrieval across real movie data, not guesses.
          </div>
        </div>
        <div class="feature-item">
          <div class="feature-icon"><i class="bi bi-graph-up-arrow"></i></div>
          <div class="feature-text">
            <strong>Learns your taste</strong>
            Every like, dislike, and rating sharpens your recommendations.
          </div>
        </div>
        <div class="feature-item">
          <div class="feature-icon"><i class="bi bi-patch-check"></i></div>
          <div class="feature-text">
            <strong>Explainable picks</strong>
            A visible match score, not a black box.
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="form-panel">
    <div class="card">
      ...
      <p class="subtitle">Get back to your personalized recommendations</p>
